...
<h1 class="emergente">Descansos Trabajados</h1>  
  ...
  <div class="columna" style="width:5px;">(</div>
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"> <input name="sueldo_descansos" id="sueldo_descansos" type="text" size="5" maxlength="10" value="<?php echo $sueldoDiario;?>" /></div>
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"><input name="factor_descansos" id="factor_descansos" type="text" size="5" maxlength="10" value="<?php echo $factor;?>" /></div>
