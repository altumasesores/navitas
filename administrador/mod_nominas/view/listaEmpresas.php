...
<?php 
...

   {
...

	   {
		   ...
		   $option="<option value='$row_empresas[id_empresa]' >$row_empresas[razon_social]</option>".$option;
...
<label>
  ...
  <option value="selecionar" disabled="disabled" selected="selected">Seleccionar:</option>
