...
<h1 class="emergente">Vacaciones</h1>  
  ...
  <div class="columna" style="width:5px;">(</div>
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"> <input name="sueldo_vacaciones" id="sueldo_vacaciones" type="text" size="5" maxlength="10"  value="<?php echo $sueldoDiario;?>" /></div>
      ...
      <div class="columna" style="width:5px;">+</div>
      <div class="columna" style="width:130px;"><input name="factorVacaciones" id="factorVacaciones" value="<?php echo $factor;?>" size="5" onchange="ajuste()"/></div>
