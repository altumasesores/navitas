...
/*   Autor: Carlos Levi
      ...
      3.- si resulta que es ciente, se redirige a clientes, si resulta q es admin, se queda en admin
           nota: no encuentro una evaluacion para admin concreta y segura.
*/
...
<!---------------------------------------------------------------------------------------------------------------------->
  ...
  <script>
    ...
    /* Aqui se setea el grupo al que pertenece,  por un error de diseño de clase, 
        ya que esto dedbió hacerse al momento de que la clase calculos hereda de la clase de transacciones */
...
<div id="container">
  ...
  <div id="menu" align="right" >
    <div align="right">
      <ul class="dropdown dropdown-horizontal" id="nav" name="nav">
        ...
        <li><a href="javascript:$('#cuerpoNomina').html('');cargarPagina('../admin/empresas.php','mainContent')">
            <img src="../imagenes/empresas.png" width="26" height="26"/>   Empresas</a>
        </li>
      ...
      <li>   
        ...
        <img src="../imagenes/nomina.png" width="26" height="26"/>Procesar Nóminas</a>
      </li>

      <li>
        <a href="javascript:$('#cuerpoNomina').html('');transaccionesNomina.cargarUPLOAD();">
        <img src="../imagenes/publicar.png" width="26" height="26"/>Publicar Documentos</a>       
      </li>
	...
	<li><span class="dir"><IMG SRC="../imagenes/reportes.png" WIDTH="25px" HEIGHT="25" ALT="Respaldo de la Base de Datos"  />Reportes</span>
		...
		<ul>
        <li align="left">   
          <a href="javascript:$('#mainContent').html('');transaccionesNomina.consultarReporteFiscal({'id_usuario':<?php echo $id_usuario?>},'cuerpoNomina','consultarReporteFiscalEmpleados','POST');">
          <img src="../imagenes/nomina.png" width="26" height="26"/>Nóminas Fiscales</a>
        </li>
		...
		<ul>
        	<li><a href="javascript:respaldarBD();transaccionesNomina.consultarNominaVistaInicial({'id_usuario':<?php echo $id_usuario?>},'cuerpoNomina','consultarEmpresasXUsuario','POST');">
                <img src="../imagenes/RespaldoBD.png" width="26" height="26"/>Respaldo</a>
          </li>
  ...
  <div id="mainContent">  
    ...
    <?php    require_once("../AnteFrontController.php"); ?>
