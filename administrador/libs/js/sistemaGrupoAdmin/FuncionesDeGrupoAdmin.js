...
var transaccionesAdministrador=function(){};
//heredamos del manejador y enviamos el grupo al que pertenece el conjunto de modulos.
transaccionesAdministrador.prototype=new transaccionesPostGet("Administrador");
//intanciamos el contructor de la clase del grupo,para evitar errores durante la herencia.
transaccionesAdministrador.prototype.constructor=transaccionesAdministrador;
/*
