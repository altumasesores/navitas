...
<div class="fila">
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"><input name="sueldo_domingos" id="sueldo_domingos" type="text" size="5" maxlength="10" value="<?php echo $sueldoDomingo;?>" readonly="readonly"  /></div>
      <div class="columna" style="width:90px; display:none;"><input name="sueldo_domingos_imss" id="sueldo_domingos_imss" type="text"  size="5" maxlength="10" value="<?php echo $sueldoDomingoImss;?>" readonly="readonly" /></div>
       <div class="columna" style="width:5px;">)</div>
      <div class="columna" style="width:5px;">+</div>   
      <div class="columna" style="width:130px;"><input name="factorDomingo" id="factorDomingo" value="<?php echo $factorDomingos;?>" size="5" onchange="ajuste()" readonly="readonly" /></div>
</div>
