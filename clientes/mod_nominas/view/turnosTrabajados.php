...
<div class="fila">
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:130px;"><input name="sueldo_turnos" id="sueldo_turnos" type="text" size="5" maxlength="10"  value="<?php echo $sueldo?>" readonly="readonly"/></div>
