...
<h1 class="emergente">Dias Festivos</h1>  
  ...
  <div class="columna" style="width:5px;">(</div>
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"> <input name="sueldo_festivos" id="sueldo_festivos" type="text" size="5" maxlength="10" value="<?php echo $sueldoDiario;?>" readonly="readonly" /></div>
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"><input name="factor_festivos" id="factor_festivos" type="text" size="5" maxlength="10" value="<?php echo $factor;?>" readonly="readonly" /></div>
