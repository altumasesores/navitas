...
?>
<a href="javascript:transaccionesNomina.consultarNominaVistaInicial(<?php echo $parametros;?>,'cuerpoNomina','consultarNominasXEmpresa','POST');" ><img src="../imagenes/anterior.png" width="24" height= "24" title="Anterior"/>Regresar al listado de Nóminas</a>
<br/><br/>
...
<?php
    ...
    while ($row_empresas=$datosEmpresaXId->fetch())
	{
	...
	while ($row_nomina = $datosNominaXId->fetch())
	{
		//variables de nomina:
...
<?php 
	...
	while ($row_empleados = $datosNominaEmpleados->fetch()){ 
...
<table  border="0" cellspacing="6" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right"><input type="button" name="aceptar_nomina" id="aceptar_nomina" value="Aceptar" onclick="javascript:autorizar_nomina(<?php echo $id_nomina; ?>,<?php echo $parametros;?>)">
    <input type="button" name="cancelar" id="cancelar" value="Cancelar"  
    onclick="javascript:$('#mainContent').html('');$('#cuerpoNomina').html('');$('#periodo').html('');transaccionesNomina.consultarNominaVistaInicial(<?php echo $parametros;?>,'cuerpoNomina','consultarNominasXEmpresa','POST');"></td>
  </tr>
 <?php }?>
  <tr>
    <td align="right">&nbsp;</td>
