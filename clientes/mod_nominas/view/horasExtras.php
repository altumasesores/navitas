...
<h1 class="emergente">Horas extras</h1>  
  ...
  <div class="columna" style="width:5px;">(</div>
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"><input name="sueldo_hora" id="sueldo_hora" type="text" size="5" maxlength="10" value="<?php echo $sueldoDiario;?>" readonly="readonly"/></div>
      ...
      <div class="columna" style="width:5px;">*</div>
      <div class="columna" style="width:60px;"><input name="factor" id="factor" type="text" size="5" maxlength="10" value="<?php echo $factorHorasExtras;?>"  readonly="readonly"/></div>
