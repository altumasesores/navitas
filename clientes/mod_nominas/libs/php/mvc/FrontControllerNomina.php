...
class FrontControllerNomina
{
	...
	static function main()
	{
		if(file_exists('mod_nominas/libs/php/mvc/configNomina.php'))
		{
			...
			}elseif(file_exists('clientes/mod_nominas/libs/php/mvc/configNominaClientes.php'))
			{
				require_once 'clientes/mod_nominas/libs/php/mvc/configNominaClientes.php';
				}
               ...
               if(isset($_GET['controlador'])){
				...
				elseif(isset($_POST['controlador'])){
                   $controllerName = $_POST['controlador'] . 'Controller';
                    ...
                    $controllerName = "NominaController";
				} 
				...
				*/
				 ...
				 $modelPath =$config->get('modelsFolder') . "ModelNomina" . '.php';
                ...
                elseif(is_file("clientes/".$controllerPath))
                      require "clientes/".$controllerPath;
			    else
                      die('El controlador no existe - 404 not found');
					  
				if(is_file($modelPath))
                      require $modelPath;
                elseif(is_file("clientes/".$modelPath))
                      require "clientes/".$modelPath;
                else
