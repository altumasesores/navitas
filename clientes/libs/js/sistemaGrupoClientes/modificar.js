...
function modificar_empleado(id_empleado, curp_empleado, no_seg_social, ap_paterno, ap_materno, nombre, cuenta_imss, fecha_alta_imss, domicilio, fecha_nacimiento, sueldo_diario_imss, estado, observaciones, periodo, sueldo_diario, no_tarjeta, infonavit) {
	//deshabilito el boton de guardar
...
function modificar_empleado_empresa(id_empleado, curp_empleado, no_seg_social, ap_paterno, ap_materno, nombre, cuenta_imss, fecha_alta_imss, domicilio, fecha_nacimiento, sueldo_diario_imss, estado, observaciones, periodo, sueldo_diario, no_tarjeta, infonavit) {
	...
	fecha_nac = d + '/' + e + '/' + f;
	ajax = objetoAjax();
	ajax.open("POST", "empleados_empresas.php", true);
...
function buscarEmpleados() {
	...
	ajax.open("POST", "empleado_consulta.php", true);
...
function buscarEmpleados_porEmpresas() {
	...
	//alert(nombre);
	ajax = objetoAjax();
	ajax.open("POST", "empleados_empresas_consulta.php", true);
