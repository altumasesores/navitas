...
function calcular_sueldo(sueldo_diario,sueldo_diario_imss,dias_trabajados, total_sueldo,total_sueldo_imss) {
	...
	sueldo_total = 
	parseFloat(document.getElementById(sueldo_diario).value) * 
	parseFloat(document.getElementById(dias_trabajados).value);
	...
	sueldo_total_imss = 
	parseFloat(document.getElementById(sueldo_diario_imss).value) *
	parseFloat(d_trabajados);
