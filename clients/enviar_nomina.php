<?php
  ...
  if (!isset($_SESSION)){
	  ...
	  include_once("../admin/empresa_clase.php");
		...
		//creo las objetos de nueva empresa y empleado
     ...
     //Obtenemos sus metodos correspondientes de empresa y empleados
		
		$listaEmpresas= $objEmpresa->consultaIdEmpresa($id_empresa);//Consulto la empresa
		
		$listaEmpleados= $objEmpleado->consultar_empleados_periodo($id_empresa, $periodo);//Consulto todas los empleados que cobran en ese periodo
		
		$listaEmpleados_imss= $objEmpleado->consultar_empleados_periodo_imss($id_empresa, $periodo);//Consulto numero de empleados con imss
...
<table width="682" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="124">
	    <strong> Nómina del periodo:</strong>
    </td>
