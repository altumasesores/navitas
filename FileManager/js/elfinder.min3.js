...
(function(a) {
    ...
    window.elFinder = function(b, c) {				
        ...
        typeof this.transport.send != "function" && (this.transport.send = function(b) {
			...
			console.debug("esto es b en transport.send(b): "+b);
			console.debug("esto es b en transport.send(b): "+JSON.stringify(b));
            return a.ajax(b)
        }),
    ...
    a.fn.elfinder = function(a) {//aqui inicia el plugin la carga de absolutamente todo, recibe un instance igual		
	
	/*
	this=diveleement
	console.debug("A    :"+JSON.stringify(a)+"\n")
	console.debug("val  :"+$(this).val()+"\n");
	console.debug("html :"+$(this).html()+"\n");
	...
	*/
    ...
    elFinder.prototype._options = {
        ...
        lang: "en",
        cssClass: "",
        commands: ["AsignarUsuario","open", "reload", "home", "up", "back", "forward", "getfile", "quicklook", "download", "rm", "duplicate", "rename", "mkdir", "mkfile", "upload", "copy", "cut", "paste", "edit", "extract", "archive", "search", "info", "view", "help", "resize", "sort"],
        commandsOptions: {
            getfile: {
                onlyURL: !0,
                multiple: !1,
        ...
        contextmenu: {
            ...
            files: ["getfile", "|","AsignarUsuario", "open", "quicklook", "|", "download", "|", "copy", "cut", "paste", "duplicate", "|", "rm", "|", "edit", "rename", "resize", "|", "archive", "extract", "|", "info"]
        },
        ...
        mixin: {
            make: function() {
                ...
                k = a('<input type="text"/>').keydown(function(b) {
					...
					//si keycode = escape entonces rechazalo de lo contrario si keycode=enter y k=blur entonces {}
					...
					alert("d: "+d);//sin valor
					alert("g: "+g);
					alert("k.val: "+k.val());//nombre del directorio
					
                    var d = a.trim(k.val()),					
                    h = k.parent();
					alert("d con valor y trim (k.val): "+d);//nombre directorio
					alert("h: "+h);//objeto circular estructure
					alert("h.length: "+h.length);//1
                    ...
                    if (h.length) {
                        ...
                        b.request({
                            ...
                            e.reject(a)
                        }).done(function(a) {//respuesta de php una vez realiada la accion
							/*
							{
								"aded":{},
								"debug":{};
    ...
    a.fn.elfindercontextmenu = function(b) {
        return this.each(function() {
            ...
            g = function(b, c, d) {
				//b español c ingles d una funcion u objeto
    ...
    function(a) {
        ...
        if (a.browser.msie && parseInt(a.browser.version) < 9) {
            ...
            e = function(a, b) {
                ...
                g *= l,
                h *= k,
                a.style.filter = (a.style.filter || "").replace(/progid:DXImageTransform\.Microsoft\.Matrix\([^)]*\)/, "") +
				 ("progid:DXImageTransform.Microsoft.Matrix(M11=" + e + ",M12=" + f + ",M21=" + g + ",M22=" + h + ",FilterType='bilinear',sizingMethod='auto expand')");
