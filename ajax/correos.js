...
function correo_nueva_empresa(razon_social, usuario, password, correo){
	...
	ajax.open("POST", "../admin/correo_nueva_empresa.php",true);
...
function correo_nuevo_usuario(usuario, password, nombre, correo){
	...
	ajax.open("POST", "../admin/correo_nuevo_usuario.php",true);
	//divResultado.innerHTML=  'Obteniendo Listado de Empresas...';
  ...
  ajax.onreadystatechange=function() {
	if (ajax.readyState==4) {		
	  ...
	  //mostrar resultados en esta capa
		  jAlert("Respuesta del correo:  " + ajax.responseText)
...
function correo_revision_nomina(id_nomina, estado_ant,callback ){
	...
	ajax.open("POST", "../admin/correo_revision_nomina.php",true);
	//divResultado.innerHTML=  'Obteniendo Listado de Empresas...';
