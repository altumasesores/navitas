...

{
	...
	function verificar_existencia_fiscal(){
		...
		$query="SELECT *	FROM nomina_fiscal	WHERE  id_nomina=$this->id_nomina";	
...

	{
		...
		$this->SalarioImss= $this->sueldo_diario_imss;//con factor					

		$this->TotalSueldoImss=$this->SalarioImss*$this->dias_trabajados_imssisrsub;	//con factor				

		$this->SueldoparaIMSS=$this->sueldo_imss*$this->dias_trabajados_imssisrsub;	//sin factor o integrado
...

	{
		...
		$this->imss=$this->getIMSS($this->sueldo_diario_imss, $this->dias_trabajados_imssisrsub);
...
;
...

	{
			  ...
			  $this->despensa=redondear($this->despensa);	  
