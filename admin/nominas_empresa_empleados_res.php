<?php 
	...
	$objNominaFiscal = new NominaFiscal($id_nomina,$id_empresa);
...
<!------------------------------------------------------------------------------------------------->
    <input type="" id="id_empresaa"        value="<?php echo $id_empresa;      ?>" />
    <input type="" id="id_nomina"          value="<?php echo $id_nomina;       ?>" />
    <input type="" id="estado_actual"      value="<?php echo $estatus;         ?>" />
    <input type="" id="iva_empresa"        value="<?php echo $porc_iva;        ?>" />
    <input type="" id="honorarios_empresa" value="<?php echo $porc_honorarios; ?>" />
<!------------------------------------------------------------------------------------------------->
...
$t_percepciones=$totales_nomina['percepciones'];
$t_deducciones=$totales_nomina['deducciones'];
$t_percepciones_fiscales=$totales_nomina['percepciones_fiscales'];
$tt_nomina=$t_percepciones-$t_deducciones;
...
?>  
  ...
  <tr>
   ...
   /></td>
    ...
    <input name="total_festivos_imss_<?php echo $row_empleados['id_empleado']; ?>" type=""  id="total_festivos_imss_<?php echo $row_empleados['id_empleado']; ?>" value="<?php echo $row_empleados_fiscales['p_total_dias_festivos']; ?>" size="5" maxlength="10" /></td>
    <td align="center" nowrap="nowrap"><input 
    type="checkbox" 
    ...
    <input name="total_vacaciones_imss_<?php echo $row_empleados['id_empleado']; ?>" type=""  id="total_vacaciones_imss_<?php echo $row_empleados['id_empleado']; ?>" value="<?php echo $row_empleados_fiscales['p_subtotal_vacaciones']; ?>" size="5" maxlength="10" /></td>
    <td><input 
...
onclick="
   ...
   &nbsp; &nbsp;  No. horas &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  sueldo<br/>
    ...
    &nbsp;*&nbsp;<input name="sueldo_hora_imss" id="sueldo_hora_imss" type=""  size="5" maxlength="10" />
    <input name="factor" id="factor" type="text" size="5" maxlength="10" value="2"/><br/>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;               
               <input type=""  id="id_total_he" />
  <input type=""  id="id_total_he_imss" />
               <input type=""  id="id_checkbox" />
...
<div  class="handle" id="handle_domingos" style="display:none;"   onclick="javascript:Drag.init(document.getElementById('handle_domingos'), document.getElementById('root_domingos'))">Domingos Trabajados</div> 
   &nbsp; &nbsp; Domingos &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sueldo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Prima dom.(25%)<br/>
    ...
    <input name="sueldo_domingos_imss" id="sueldo_domingos_imss" type=""  size="5" maxlength="10" />
    &nbsp;  +  &nbsp;   Prima Dominical (25%) <br/>
    
			     <input type="" id="id_total_domingos" />
                 <input type="" id="id_total_domingos_imss" />
  <input type="" id="id_checkbox" />
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;               
...
<div  class="handle" id="handle_turnos" style="display:none;"   onclick="javascript:Drag.init(document.getElementById('handle_turnos'), document.getElementById('root_turnos'))">Turnos Trabajados</div> 
   ...
   <input name="sueldo_turnos_imss" id="sueldo_turnos_imss" type=""  size="5" maxlength="10" />
    <br/>
     		<input type=""  id="id_total_turnos" />
            <input type=""  id="id_total_turnos_imss" />
               <input type="" id="id_checkbox" />
...
<div  class="handle" id="handle_descansos" style="display:none;"   onclick="javascript:Drag.init(document.getElementById('handle_descansos'), document.getElementById('root_descansos'))">Descansos Trabajados</div> 
   &nbsp; &nbsp; No.Descansos &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sueldo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  factor<br/>
	...
	&nbsp; 
        ...
        <input name="sueldo_descansos_imss" id="sueldo_descansos_imss" type=""  size="5" maxlength="10" />
    &nbsp;*&nbsp;<input name="factor_descansos" id="factor_descansos" type="text" size="5" maxlength="10" value="2"/><br/>
    			<input type=""  id="id_total_descansos" />
                <input type=""  id="id_total_descansos_imss" />
                <input type="" id="id_checkbox" />
   ...
   &nbsp; &nbsp;  No. Dias &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sueldo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; factor<br/>
    ...
    (<input name="no_festivos" id="no_festivos" type="text" size="5" maxlength="10" />
      &nbsp;*&nbsp;
        ...
        <input name="sueldo_festivos_imss" id="sueldo_festivos_imss" type=""  size="5" maxlength="10" />
    &nbsp;*&nbsp;<input name="factor_festivos" id="factor_festivos" type="text" size="5" maxlength="10" value="2"/><br/>
    
	    <input type="" id="id_total_festivos" />
         <input type="" id="id_total_festivos_imss" />
               	<input type="" id="id_checkbox" />
...
<div  class="handle" id="handle_vacaciones" style="display:none;"   onclick="javascript:Drag.init(document.getElementById('handle_vacaciones'), document.getElementById('root_vacaciones'))">Vacaciones</div> 
   &nbsp; &nbsp;  No. Dias &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  sueldo<br/>
    ...
    <input name="sueldo_vacaciones_imss" id="sueldo_vacaciones_imss" type=""  size="5" maxlength="10" />
    &nbsp;+&nbsp;Prima Vacacional (25%)<br/>
    <input type="" id="id_total_vacaciones" />
    <input type="" id="id_total_vacaciones_imss" />
                   	<input type="" id="id_checkbox" />
